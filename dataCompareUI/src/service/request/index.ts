...
export const request = createFlatRequest<App.Service.Response, RequestInstanceState>(
  ...
  },
  {
    ...
    isBackendSuccess(response) {
      ...
      const successCodes = import.meta.env.VITE_SERVICE_SUCCESS_CODE?.split(',') || ['0000'];
    ...
    transformBackendResponse(response) {
      // 检查响应数据结构，优先使用content字段，如果不存在则使用data字段
      return response.data.content !== undefined ? response.data.content : response.data.data;
    },
    onError(error) {
