...
import com.crunchydata.system.enums.MenuTypeEnums;
...
import com.crunchydata.system.mapper.SysResourceMapper;
import com.crunchydata.system.result.Result;
import com.crunchydata.system.result.ResultCode;
import com.crunchydata.system.service.SysResourceService;
import com.crunchydata.system.util.ExceptionUtil;
import com.crunchydata.system.util.SysUserDetail;
import com.crunchydata.system.vo.Meta;
...
import com.crunchydata.system.util.RouteUtil;
...
//            sysResource.setUiPath(sysResources.getFirst().getUiPath() + randomString + sysResource.getRoutePath());
            sysResource.setUiPath(sysResources.get(0).getUiPath() + randomString + sysResource.getRoutePath());
